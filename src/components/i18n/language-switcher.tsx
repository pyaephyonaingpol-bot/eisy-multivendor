...
import { LOCALES, LOCALE_LABELS, type AppLocale } from "@/lib/i18n/config";
  ...
  return (
    ...
    >
      ...
      <select
        ...
        className="min-h-9 rounded-full border border-zinc-200 bg-white px-2.5 py-1.5 text-xs font-medium text-zinc-800 hover:border-zinc-300 disabled:opacity-60"
      >
        {LOCALES.map((code) => (
