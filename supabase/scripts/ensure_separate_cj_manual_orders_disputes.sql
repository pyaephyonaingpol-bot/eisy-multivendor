-- =============================================================================
-- ensure_separate_cj_manual_orders_disputes.sql (paste-ready)
--
-- Prefer the single-shot script instead:
--   supabase/scripts/ensure_complete_orders_disputes_schema.sql
-- It includes all prerequisites (customer_id, seller_vendor_id,
-- supplier_order_ref, updated_at, disputes, cj_* tables, etc.) in one run.
--
...
-- Without this, indexes / triggers referencing seller_vendor_id fail.
