-- =============================================================================
-- ensure_submit_vendor_kyc.sql
--
-- Paste-ready: create public.submit_vendor_kyc with exact app parameter names
-- (p_document_type, p_document_path, p_document_url, p_legal_name,
-- p_document_number) plus review_vendor_kyc and KYC privilege-guard fix.
-- =============================================================================
