-- =============================================================================
-- ensure_wallets_for_supplier_refund.sql
--
-- Paste-ready: create public.wallets (USDT + MMK + escrow), wallet_transactions,
-- order_escrow_ledger, ensure_user_wallets, and recreate
-- refund_order_supplier_unavailable so supplier OOS refunds work.
-- =============================================================================
